    ...
    <div class="col-md-8"> 
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items center"> 
                <h3>{{ $post->title }}</h3> 
                <div> 
                    <a href="{{ route('posts.edit', $post->id) }}" class="btn btn
warning btn-sm">Edit</a> 
                    <a href="{{ route('posts.index') }}" class="btn btn-secondary btn
sm">Back</a> 
                </div> 
            </div> 
            <div class="card-body"> 
...
confirm('Are you sure you want to delete this post?')">Delete Post</button> 
            </form> 
        </div> 
    </div> 
</div> 
